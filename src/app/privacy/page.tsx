...
export const metadata = {
  title: "Privacy Policy — Lync",
  description: "How Lync collects, uses, and protects your data.",
};
        ...
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          {[
            ...
            },
            {
              ...
              content: `Room data (messages, attendance logs) persists in Firebase until you or the room host explicitly deletes it. You can request deletion of your account and associated data by contacting us at support@lyncc.netlify.app. We will process deletion requests within 30 days.`
            },
            {
              title: "7. Your Rights",
            ...
            {
              title: "10. Contact",
              content: `For privacy-related questions or requests, contact us at: privacy@lyncc.netlify.app or visit our support page at https://lyncc.netlify.app/support.`
            },
          ].map((section) => (
